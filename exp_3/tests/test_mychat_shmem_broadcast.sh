#!/bin/bash
# test_mychat_shmem_broadcast.sh
# Tests: host correctly broadcasts through the semaphore producer-consumer
# scheme to all clients in SHMEM mode.
# Usage: test_mychat_shmem_broadcast.sh path/to/mychat
