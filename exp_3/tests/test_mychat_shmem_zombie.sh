...
echo "alive_check_1" >&4
wait_for_line "$TEST_DIR/alice.log" "alive_check_1" || fail "Communication failed after zombie death"

echo "alive_check_2" >&4
wait_for_line "$TEST_DIR/alice.log" "alive_check_2" || fail "Second message failed"
